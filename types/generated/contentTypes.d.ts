...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'About page content including mission, leadership, and timeline';
  ...
  attributes: {
    ...
    keyHighlightsTitle: Schema.Attribute.String;
...
export interface ApiBlogCategoryBlogCategory
  ...
  info: {
    description: 'Categories for blog posts and news';
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Success stories highlighting security engagements';
  ...
  attributes: {
    ...
    seo: Schema.Attribute.Component<'shared.seo', false>;
    servicesUsed: Schema.Attribute.Relation<
      'manyToMany',
      'api::service.service'
    >;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiClientCategoryClientCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'client_categories';
  info: {
    description: 'Groups of clients displayed on the clients page';
...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Organizations that work with the security company';
    displayName: 'Client';
    pluralName: 'clients';
    singularName: 'client';
  };
...
export interface ApiClientsPageClientsPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Clients page sections and category listings';
  ...
  attributes: {
    clientCategories: Schema.Attribute.Relation<
      'oneToMany',
      'api::client-category.client-category'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiCompanyInfoCompanyInfo extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Core company profile displayed across the site';
  ...
  attributes: {
    aboutSnippet: Schema.Attribute.RichText;
    businessHours: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    emails: Schema.Attribute.Component<'shared.email-item', true>;
    foundedYear: Schema.Attribute.Integer;
    foundedYearBs: Schema.Attribute.String;
    headOfficeAddress: Schema.Attribute.Text;
    ...
    > &
      Schema.Attribute.Private;
    phoneNumbers: Schema.Attribute.Component<'shared.phone-item', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Contact page form messaging, location, and map';
...
export interface ApiContactRequestContactRequest
  ...
  info: {
    description: 'Inbound contact and quote requests';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    serviceInterestedIn: Schema.Attribute.Relation<
      'manyToOne',
      'api::service.service'
    >;
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['General', 'Services', 'Billing', 'Operations', 'Other']
    > &
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage hero, highlights, and featured content';
...
export interface ApiMediaGalleryMediaGallery
  ...
  info: {
    description: 'Photo galleries for operations, training, and events';
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Operations', 'Training', 'Events', 'Ceremonies', 'Community', 'Other']
    > &
      Schema.Attribute.DefaultTo<'Operations'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
...
export interface ApiServiceAreaServiceArea extends Struct.CollectionTypeSchema {
  collectionName: 'service_areas';
  info: {
    description: 'Geographic locations served';
    displayName: 'Service Area';
    pluralName: 'service-areas';
    singularName: 'service-area';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Service offerings for the security company';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    ...
    featureColumns: Schema.Attribute.Component<'service.feature-column', true>;
    ...
    > &
      Schema.Attribute.DefaultTo<'Guarding'>;
...
export interface ApiServicesPageServicesPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Services overview page content';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customSolutionButtonLabel: Schema.Attribute.String;
    customSolutionButtonLink: Schema.Attribute.String;
    customSolutionText: Schema.Attribute.RichText;
    customSolutionTitle: Schema.Attribute.String;
    ...
    servicesIntroLabel: Schema.Attribute.String;
    subtitle: Schema.Attribute.RichText;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSiteSettingsSiteSettings extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global configuration and footer content';
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Leadership and core team profiles';
